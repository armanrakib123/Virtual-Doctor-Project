            ...
            setFilterDoc(
                doctors.filter(
                    (doc) =>
                        ...
                        decodeURIComponent(specialty).toLowerCase().trim()
                )
            );
        } else {
            ...
            <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
                ...
                >
                    <p
                        onClick={() =>
                            specialty === 'General physician'
                                ? router.push('/doctors')
                                : router.push('/doctors/General%20physician')
                        }
                        className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${decodeURIComponent(specialty || '') === 'General physician'
                    ...
                    <p
                        ...
                        className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${specialty === 'Dermatologist' || specialty === 'Dermatology'
                                ? 'bg-indigo-100 text-black'
                                : ''
                            }`}
                    >
