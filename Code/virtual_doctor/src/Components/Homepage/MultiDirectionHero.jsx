...
export default function MultiDirectionHero({
    bgImage = "https://images.unsplash.com/photo-1503264116251-35a269479413?q=80&w=1600&auto=format&fit=crop&ixlib=rb-4.0.3&s=abcd",
    className = "",
}) {
    return (
        <section
        ...
        >
            ...
            <header className="h-[600px] mx-16 my-12 pt-16">
                ...
                <div className="relative">
                    ...
                    <div className="flex items-center gap-6 pt-18">
                        <div><button className="group relative inline-flex h-[calc(48px+8px)] items-center justify-center rounded-full bg-neutral-900 py-1 pl-6 pr-14 font-medium text-neutral-50">
                            <span className="z-10 pr-2">Book Appointment</span>
                            <div className="absolute right-1 inline-flex h-11 w-11 items-center justify-end rounded-full bg-neutral-700 transition-[width] group-hover:w-[calc(100%-8px)]">
