...
const navItems = [
  { href: "/doctor_profile/", label: "Dashboard", icon: <FaTachometerAlt /> },
  { href: "/doctor_profile/profile_update", label: "Profile Management", icon: <FaUserMd /> },
  { href: "/doctor_profile/appointments", label: "Appointment Management", icon: <FaCalendarAlt /> },
  { href: "/doctor_profile/patients", label: "Patient Medical Records", icon: <FaUsers /> },
  { href: "/doctor_profile/prescription", label: "E-Prescription", icon: <FaFilePrescription /> },
  { href: "/doctor_profile/payments", label: "Payment Management", icon: <FaMoneyBillWave /> },
];
