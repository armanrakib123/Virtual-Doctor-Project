...
const Navbar = () => {
  ...
  return (
    <div className="navbar fixed py-8 px-22 top-0 z-50 bg-base-300/80 backdrop-blur-sm shadow-md">
        ...
        <div>
          <Link href="/" className="flex gap-1 btn-ghost text-xl">
            ...
            <span className="font-bold text-3xl">VirtualDoc</span>
          </Link>
        </div>
                      ...
                      <div className="card w-1/2 shadow-xl image-full">
                        ...
                        <div className="card-body justify-end">
                          ...
                          <div className="card-actions">
                            {/* You can also make promo buttons links */}
